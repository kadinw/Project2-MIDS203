...
contrasts(exploration_set$Occupation) <- contr.sum(n = length(levels(exploration_set$Occupation)))
...
**Exploration Quality of Sleep:**
  ...
  Here, we show a basline model giving a visual of our coefficients for quality of sleep based on occupation.
  
```{r, echo=FALSE, message=FALSE, warning=FALSE}
#summary(model_exploration)
levels(exploration_set$Occupation)
...
Here we see a general representation of reported sleep quality, and associated occupation based on our filtered data.
```{r}
